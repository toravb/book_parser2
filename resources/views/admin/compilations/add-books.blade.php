<x-layouts.admin-layout>
    ...
    <x-slot name="title">Список книг для добавления в подборку {{ $compilation->title }}</x-slot>
    <div class="row">
        <div class="col-12">
            <div class="card">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex">
                                        @if(!$book->added)
                                            <x-button-add
                                                :route="route('admin.compilations.store-book', [$compilation, $book, 'type'=>$book->type])">
                                            </x-button-add>
                                        @endif
                                    </div>
                                </td>
